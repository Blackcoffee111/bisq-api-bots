...
payment_account_id = "222f2673-abf7-4467-9d71-dd582fc5aee1"
password = "xyz"
direction = "SELL"
currency_code = "EUR"
...
for i in range(4):
    price = str(10000*(i+1))
    send_order(True, price=price, amount=1000000, min_amount=100000, security_deposit=15, fee_currency="BSQ")
